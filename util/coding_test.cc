...
TEST_CASE("Fixed32 coding", "[coding]") {
  std::string s;
...
TEST_CASE("Fixed64 coding", "[coding]") {
  std::string s;
...
TEST_CASE("Encoding routines generate little-endian encodings", "[coding]") {
  std::string dst;
...
TEST_CASE("Varint32 coding", "[coding]") {
  std::string s;
...
TEST_CASE("Varint64 coding", "[coding]") {
...
TEST_CASE("Strings coding", "[coding]") {
  std::string s;
